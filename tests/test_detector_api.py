...
def _nominal_design(d):
    ...
    return detopt.detector.free_design_array(
        [8407.0, 8607.0, 9307.0, 9507.0], n_layers_per_view=d.n_layers_per_view, B=d.max_B
    )
...
def test_shape_invariants():
    ...
    # (like DebugDetector), not a broadcast of the whole design.
